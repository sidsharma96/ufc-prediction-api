...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_imports_source_started", "data_imports", ["source", "started_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "weight_class", sa.String(length=50), nullable=True, comment="Primary weight class"
        ),
        sa.Column(
            "stance", sa.String(length=20), nullable=True, comment="Orthodox, Southpaw, or Switch"
        ),
    ...
    op.create_index(
        "idx_fighters_weight_class_active", "fighters", ["weight_class", "is_active"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "fight_order", sa.Integer(), nullable=True, comment="Position on card (1 = main event)"
        ),
    ...
    op.create_index(
        "idx_snapshots_fighter_date",
        "fighter_snapshots",
        ["fighter_id", "snapshot_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_fighter_snapshots_fight_id"), "fighter_snapshots", ["fight_id"], unique=False
    )
    op.create_index(
        op.f("ix_fighter_snapshots_fighter_id"), "fighter_snapshots", ["fighter_id"], unique=False
    )
    op.create_index(
        op.f("ix_fighter_snapshots_snapshot_date"),
        "fighter_snapshots",
        ["snapshot_date"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_system_predictions_fight_id"), "system_predictions", ["fight_id"], unique=False
    )
    op.create_index(
        op.f("ix_system_predictions_is_correct"), "system_predictions", ["is_correct"], unique=False
    )
